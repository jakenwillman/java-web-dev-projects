...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Sprinkles", 0.25, new ArrayList<>(Arrays.asList("artificial colors")));
        Topping topping2 = new Topping("Chocolate Chips", 0.30, new ArrayList<>(Arrays.asList("dairy")));
        Topping topping3 = new Topping("Pecans", 0.40, new ArrayList<>(Arrays.asList("nuts")));
